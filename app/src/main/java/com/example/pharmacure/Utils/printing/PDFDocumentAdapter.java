package com.example.pharmacure.Utils.printing;
...
public class PDFDocumentAdapter extends ThreadedPrintDocumentAdapter{
   public PDFDocumentAdapter(Context ctxt) {
    ...
    @Override
    WriteJob buildWriteJob(PageRange[] pages, ParcelFileDescriptor destination, CancellationSignal cancellationSignal, WriteResultCallback callback, Context ctxt) {
        return null;
    }
