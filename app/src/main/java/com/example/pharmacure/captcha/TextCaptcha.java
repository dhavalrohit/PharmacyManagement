...
public class TextCaptcha extends captchamodel{
    protected com.rogerlemmonapps.captcha.TextCaptcha.TextOptions options;
    ...
    public TextCaptcha(int wordLength, com.rogerlemmonapps.captcha.TextCaptcha.TextOptions opt){
        new  TextCaptcha(0, 0, wordLength, opt);
    }

    public TextCaptcha(int width, int height, int wordLength, com.rogerlemmonapps.captcha.TextCaptcha.TextOptions opt){
        setHeight(height);
        setWidth(width);
        this.options = opt;
