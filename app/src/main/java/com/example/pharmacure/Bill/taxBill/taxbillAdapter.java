...
public class taxbillAdapter extends ArrayAdapter<BillModel> {
    ...
    taxBill_Activity txactivity=new taxBill_Activity();
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        holder.productname.setText(model.getProductName()+" "+model.getPackaging());
       ...
       /* double calculateddiscvalue=(rateperunit*finalquantity*setdiscperc)*100.00;
        ...
        holder.taxablevalue.setText(String.valueOf(Utility.calctaxvalue(Double.parseDouble(model.getGst()),rateperunit,setdiscperc,finalquantity)));
        ...
        finaldiscountvalue=Utility.calculatediscountvalue(mrp,Integer.parseInt(unit),finalquantity,dsgstvalue,dcgstvalue,Utility.calctaxvalue(Double.parseDouble(model.getGst()),rateperunit,setdiscperc,finalquantity));
        dtinterface.onsetvalues(finaldiscountvalue);
        ...
        holder.cgstvalue.setText(String.valueOf((Utility.calctaxvalue(Double.parseDouble(model.getGst()),rateperunit,setdiscperc,finalquantity)*Double.parseDouble(cgstrate))/100.00),2))));
