...
public class BillAdapter extends ArrayAdapter<BillModel> {
    ...
    private class ViewHolder {
        ...
        TextView  batchno,packaging,expiry,mrp,rate,gst,amount,productname,companyname,qty,looseqty,gstprec;
        Button  qty_label,deletebtn;
    }
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        if (convertView == null) {
           ...
           holder.mrp=convertView.findViewById(R.id.mrp_listitem);
            ...
            holder.deletebtn=(Button)convertView.findViewById(R.id.delete_list_btn);
        ...
        holder.deletebtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                deletealert.setMessage("Are you sure to delete this transaction?");
                ...
                deletealert.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        TransactionActivity.billtotalamount= TransactionActivity.billtotalamount-Double.parseDouble(listModels.get(position).getTotalAmount());
                        TransactionActivity.totalamounttext.setText(String.valueOf(TransactionActivity.billtotalamount));
