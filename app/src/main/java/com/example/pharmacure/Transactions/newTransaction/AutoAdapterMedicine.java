...
public class AutoAdapterMedicine extends ArrayAdapter<MedicineModel> {
    ...
    String productName = "", mrp = "", packaging = "", expdate = "", batch = "", key = "", oqty="", productID = "",gstNo="",rate="",hsncode="",discperc="",
            taxrate="";
    ...
    Filter nameFilter = new Filter() {
        ...
        public CharSequence convertResultToString(Object resultValue) {
            ...
            hsncode=((MedicineModel)resultValue).getHsnNo();
            discperc=((MedicineModel)resultValue).getDiscountperc();
